...
func NewGrypeServerAPI(spec *loads.Document) *GrypeServerAPI {
	return &GrypeServerAPI{
		...
		PostScanSBOMHandler: PostScanSBOMHandlerFunc(func(params PostScanSBOMParams) middleware.Responder {
			return middleware.NotImplemented("operation PostScanSBOM has not yet been implemented")
		}),
	}
}
...
func (o *GrypeServerAPI) Validate() error {
	...
	if o.PostScanSBOMHandler == nil {
		unregistered = append(unregistered, "PostScanSBOMHandler")
	}
...
func (o *GrypeServerAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/scanSBOM"] = NewPostScanSBOM(o.context, o.PostScanSBOMHandler)
}
